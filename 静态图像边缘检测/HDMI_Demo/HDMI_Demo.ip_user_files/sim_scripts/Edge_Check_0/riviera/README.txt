...
#
# Generated by export_simulation on Thu Jul 30 00:58:32 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Edge_Check_0.sh' script.

./Edge_Check_0.sh -reset_run
...
./Edge_Check_0.sh -noclean_files

For more information on the script, please type './Edge_Check_0.sh -help'.
