...
HD_PWD='C:/Users/mac/Desktop/Mini-HDMI-Interface/HDMI_Demo/HDMI_Demo.runs/Edge_Check_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Edge_Check_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Edge_Check_0.tcl
