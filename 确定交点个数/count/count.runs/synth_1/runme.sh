...
HD_PWD='C:/Users/mac/Desktop/拟提交文件/序列上升沿检测并输出上升沿的个数/count/count.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter10.tcl
