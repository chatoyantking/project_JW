...
HD_PWD='C:/Users/mac/Desktop/project_2/project_2.runs/Recognize_num_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Recognize_num_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Recognize_num_0.tcl
