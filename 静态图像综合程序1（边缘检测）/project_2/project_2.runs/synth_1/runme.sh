...
HD_PWD='C:/Users/mac/Desktop/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log recognization_num.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source recognization_num.tcl
