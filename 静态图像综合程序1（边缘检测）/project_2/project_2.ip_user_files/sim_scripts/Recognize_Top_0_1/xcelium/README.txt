...
#
# Generated by export_simulation on Fri Jul 31 04:16:03 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Recognize_Top_0.sh' script.

./Recognize_Top_0.sh -reset_run
...
./Recognize_Top_0.sh -noclean_files

For more information on the script, please type './Recognize_Top_0.sh -help'.
