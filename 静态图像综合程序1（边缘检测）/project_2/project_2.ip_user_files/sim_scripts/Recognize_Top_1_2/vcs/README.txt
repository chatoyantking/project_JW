...
#
# Generated by export_simulation on Fri Jul 31 07:11:30 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Recognize_Top_1.sh' script.

./Recognize_Top_1.sh -reset_run
...
./Recognize_Top_1.sh -noclean_files

For more information on the script, please type './Recognize_Top_1.sh -help'.
