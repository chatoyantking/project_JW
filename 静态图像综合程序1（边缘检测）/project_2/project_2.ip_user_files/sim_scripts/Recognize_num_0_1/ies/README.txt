...
#
# Generated by export_simulation on Fri Jul 31 10:53:30 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Recognize_num_0.sh' script.

./Recognize_num_0.sh -reset_run
...
./Recognize_num_0.sh -noclean_files

For more information on the script, please type './Recognize_num_0.sh -help'.
